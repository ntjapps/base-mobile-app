...
var index = {
    ...
    directives: {
        ripple: {
            root: {
                class: [
                    "block absolute bg-white/50 rounded-full pointer-events-none",
                ],
    ...
    tabview: {
        ...
        nav: {
            class: [
                ...
                "dark:border-blue-900/40 dark:text-white/80 ",
        ...
        mask: function mask(_ref21) {
            ...
            return {
                class: [
                    ...
                    "transition duration-200 z-20 transition-colors",
                    {
                        "bg-black/40": props.modal,
                    },
                ],
            ...
            root: function root(_ref39) {
                ...
                return {
                    class: [
                        ...
                        "focus:outline-none focus:outline-offset-0",
                        {
                            "rounded-md rounded-br-none rounded-bl-none rounded-bl-none !p-0 flex-1 w-[3rem]":
                                parent.props.showButtons &&
                                parent.props.buttonLayout == "stacked",
                        },
                        {
                            "order-3 px-4 py-3 text-base rounded-md":
                                parent.props.buttonLayout == "horizontal",
                        },
                    ],
                };
            ...
            root: function root(_ref40) {
                ...
                return {
                    class: [
                        ...
                        "focus:outline-none focus:outline-offset-0",
                        {
                            "rounded-md rounded-tr-none rounded-tl-none rounded-tl-none !p-0 flex-1 w-[3rem]":
                                parent.props.showButtons &&
                                parent.props.buttonLayout == "stacked",
                        },
                        {
                            "order-1 px-4 py-3 text-base rounded-md":
                                parent.props.buttonLayout == "horizontal",
                        },
                    ],
                };
    ...
    cascadeselect: {
        ...
        label: {
            class: [
                "block whitespace-nowrap overflow-hidden flex flex-1 w-1 text-ellipsis cursor-pointer",
        ...
        menuitem: function menuitem(_ref97) {
            ...
            return {
                class: [
                    ...
                    {
                        "hover:scale-150":
                            instance.currentIndex === context.index,
                        "scale-125":
    ...
    megamenu: {
        ...
        menu: {
            class: [
                "m-0 sm:p-0 list-none relative",
                "outline-none",
                "flex items-center flex-wrap flex-row top-auto left-auto relative bg-transparent shadow-none w-auto",
            ],
        },
    ...
    tabmenu: {
        ...
        menu: {
            class: [
                ...
                "bg-white border-solid border-gray-300 border-b-2 dark:bg-gray-900 dark:border-blue-900/40",
    ...
    tree: {
        root: {
            class: [
                ...
                "border border-solid border-gray-300 dark:border-blue-900/40 bg-white dark:bg-gray-900 text-gray-700 dark:text-white/80 p-5 rounded-md",
            ],
        },
        wrapper: {
            class: "overflow-auto",
            ...
            return {
                class: [
                    ...
                    "transition duration-200",
                    {
                        ...
                        "text-blue-700 bg-blue-500/30 dark:bg-blue-300/30":
                            context.active && context.focused,
                        "text-gray-600 bg-gray-300 dark:bg-blue-900/40":
                            !context.active && context.focused,
                    },
                ],
            };
                    ...
                    class: [
                        ...
                        //Dark Mode
                        {
                            ...
                            "sticky z-[1]":
                                ...
                                context.scrollDirection === "both" &&
                                context.frozen,
                            "border-x-0 border-l-0 border-t-0":
                        ...
                        // Dark Mode
                        {
                            ...
                            "border-x border-y":
                                context === null || context === void 0
                                    ? void 0
                                    : context.showGridlines,
                            "overflow-hidden whitespace-nowrap border-y relative bg-clip-padding":
            ...
            return {
                class: [
                    ...
                    context.stripedRows
                        ? context.index % 2 === 0
                            ? "bg-white text-gray-600 dark:bg-gray-900"
                            : "bg-blue-100/50 text-gray-600 dark:bg-gray-950"
                        : "",
                    "transition duration-200",
                    "focus:outline focus:outline-[0.15rem] focus:outline-blue-200 focus:outline-offset-[-0.15rem]",
                    // Focus
